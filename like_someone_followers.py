...
if __name__ == '__main__':
    ...
    while True:
        with smart_run(session):
            ...
            session.set_action_delays(enabled=True, like=600, randomize=True, random_range_from=10, random_range_to=100)
            ...
            session.interact_user_followers(['mahinakealo.skin'], amount=1000, randomize=True)
